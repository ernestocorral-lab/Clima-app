...
export const translations = {
  es: {
    ...
    widget: {
      ...
      empty:
        'No hay widgets en la pantalla de inicio. Mantén pulsado el escritorio y añade el widget «Clima».',
  ...
  en: {
    ...
    widget: {
      ...
      empty: 'No widgets on the home screen. Long-press the home screen and add the «Weather» widget.',
